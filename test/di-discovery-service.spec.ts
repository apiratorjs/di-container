...
describe("DiDiscoveryService", () => {
  ...
  describe("getServicesByServiceToken", () => {
    ...
    it("should return empty array for undefined token", () => {
      const result = discoveryService.getServicesByServiceToken(undefined as any);
    ...
    it("should handle multiple services with same token if they exist", () => {
      ...
      const result = discoveryServiceWithDuplicate.getServicesByServiceToken("SERVICE_A");
  ...
  describe("getServicesByLifetime", () => {
    ...
    it("should return empty array for non-existent lifetime", () => {
      const result = discoveryService.getServicesByLifetime("invalid" as TLifetime);
  ...
  describe("edge cases and error handling", () => {
    ...
    it("should handle services with null values gracefully", () => {
      ...
      const discoveryServiceWithNulls = new DiDiscoveryService(() => servicesWithNulls);
  ...
  describe("Integration Tests with DiConfigurator", () => {
    ...
    describe("Singleton Service Discovery", () => {
      it("should discover singleton services with different token types", () => {
        ...
        diConfigurator.addSingleton(DATABASE_TOKEN, () => new DatabaseService(), undefined, "database");
        diConfigurator.addSingleton(API_TOKEN, (container) => 
          container.resolve(DATABASE_TOKEN).then(db => new ApiService(db as DatabaseService)), 
          undefined, "api"
        );
        ...
        // Test by token type
        const symbolServices = discoveryService.getServicesByServiceToken(DATABASE_TOKEN);
        ...
        const stringServices = discoveryService.getServicesByServiceToken(API_TOKEN);
        ...
        const classServices = discoveryService.getServicesByServiceToken(LOGGER_TOKEN);
      ...
      it("should discover singleton services by lifetime", () => {
        diConfigurator.addSingleton(DATABASE_TOKEN, () => new DatabaseService());
        diConfigurator.addSingleton(API_TOKEN, () => new ApiService({} as DatabaseService));
      ...
      it("should discover singleton services by tag", () => {
        diConfigurator.addSingleton(DATABASE_TOKEN, () => new DatabaseService(), undefined, "infrastructure");
        diConfigurator.addSingleton(API_TOKEN, () => new ApiService({} as DatabaseService), undefined, "infrastructure");
        diConfigurator.addSingleton(LOGGER_TOKEN, () => new LoggerService(), undefined, "logging");
    ...
    describe("Scoped Service Discovery", () => {
      it("should discover scoped services with different configurations", () => {
        diConfigurator.addScoped(DATABASE_TOKEN, () => new DatabaseService(), "database");
        diConfigurator.addScoped(API_TOKEN, (container) => 
          container.resolve(DATABASE_TOKEN).then(db => new ApiService(db as DatabaseService)), 
          "api"
        );
      ...
      it("should discover scoped services by token", () => {
        ...
        const dbServices = discoveryService.getServicesByServiceToken(DATABASE_TOKEN);
        ...
        const loggerServices = discoveryService.getServicesByServiceToken(LOGGER_TOKEN);
    ...
    describe("Transient Service Discovery", () => {
      it("should discover transient services", () => {
        diConfigurator.addTransient(DATABASE_TOKEN, () => new DatabaseService(), "database");
        diConfigurator.addTransient(API_TOKEN, () => new ApiService({} as DatabaseService), "api");
        diConfigurator.addTransient(LOGGER_TOKEN, () => new LoggerService(), "logging");
    ...
    describe("Mixed Lifetime Discovery", () => {
      it("should discover services across different lifetimes", () => {
        ...
        diConfigurator.addSingleton(DATABASE_TOKEN, () => new DatabaseService(), undefined, "core");
        diConfigurator.addScoped(API_TOKEN, () => new ApiService({} as DatabaseService), "core");
    ...
    describe("Service Registration State", () => {
      it("should track service resolution state correctly", async () => {
        diConfigurator.addSingleton(DATABASE_TOKEN, () => new DatabaseService());
        diConfigurator.addSingleton(LOGGER_TOKEN, () => new LoggerService(), { eager: true });
    ...
    describe("Real-world Integration Scenarios", () => {
      it("should work with complex service dependency chains", () => {
        ...
        diConfigurator.addSingleton("CONFIG", () => ({ dbUrl: "localhost", apiPort: 3000 }), undefined, "config");
        
        diConfigurator.addSingleton(DATABASE_TOKEN, async (container) => {
      ...
      it("should discover services after module registration", () => {
        ...
        const testModule = {
          register: (configurator: IDiConfigurator) => {
            configurator.addSingleton("MODULE_SERVICE_1", () => ({ name: "Service1" }), undefined, "module");
            configurator.addScoped("MODULE_SERVICE_2", () => ({ name: "Service2" }), "module");
          }
        };

        // Register services before module
        diConfigurator.addTransient(LOGGER_TOKEN, () => new LoggerService(), "core");
